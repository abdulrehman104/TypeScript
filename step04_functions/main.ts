...
function optional(name: string, greeting?: string) {
  if (greeting) {
...
function defult(name: string, greeting: string = "Hello") {
  console.log(`${greeting}, ${name}!`);
}
...
function sumNumbers(baseNumber: number, ...numbers: number[]): number {
  let sum = baseNumber;
...
// Function overloading allows you to define multiple signatures for a function, each specifying a different set of parameter types and return type. This enables the TypeScript compiler to check the correctness of function calls based on the provided arguments.

function overload(arg1: number, arg2: number): string; // overload
function overload(arg1: string, arg2: number): string; // overload
function overload(arg1: string, arg2: string): string; // overload
...
// you can use function type expressions to define the type of a function. This allows you to explicitly specify the parameter types and return type of a function. Function types are useful in scenarios like declaring the types of callback functions, assigning functions to variables, or specifying the types of function parameters in interfaces or classes.

// Function type expression
type typeExpression = (name: string, greeting: string) => string;

// Function adhering to the defined type  
const expression: typeExpression = (name, greeting) => {
