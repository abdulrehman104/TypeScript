...
// ARRAY METHODS
let arr4: string[] = ["fareed", "lukman", "imran", "rehman"];
console.log(arr4);
...
let arr5 : string[]= ["Abdul","Rehman","Rashid","Hassan","Osaid","MOIZ"]
let nerArray: string[] = arr5.slice(1,3)
...
let arr6 : string[]= ["Hamzah","Atif","Rashid","Hassan","Osaid","MOIZ"]
